 ...
 * @author rm-rf
 */
@WebServlet(name = "ConsultarTorneos", urlPatterns = {"/Apostador/ConsultarTorneos"})
public class ConsultarTorneos extends HttpServlet {
    
    private final static java.util.logging.Logger LOGGER = java.util.logging.Logger.getLogger(ConsultarTorneos.class.getName());
    
    private TorneoDB torneoDB = new TorneoDB();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/apostador/consultarTorneosVista.jsp").forward(request, response);
    }
